...
<div class="w-screen">
    ...
    <div class="w-8/12 h-4/6 mx-auto mt-20">
        ...
        <h3 class="text-gray-600 inline-block ml-48 w-2/12 mt-10">Nueva Contraseña</h3>
        ...
        <h3 class="text-gray-600 inline-block ml-48 w-2/12 mt-10">Confirmar Contraseña</h3>
        <input type="password" placeholder="●●●●●●●" name="name" class="rounded-lg bg-gray-100 border-0 inline-block w-3/12 mt-10">

        <h3 class="text-gray-600 inline-block w-2/12 mt-10">Antigua contraseña</h3>
        <input type="password" placeholder="●●●●●●●" name="name" class="rounded-lg bg-gray-100 border-0 inline-block w-3/12 mt-10">

        <input type="submit" value="GUARDAR CAMBIOS" class="block w-2/12 h-10 bg-green-700 text-white mt-14 mx-auto">
    </div>
