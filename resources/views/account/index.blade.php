...
@section('content')
    <div class="container mx-auto px-4 py-4">
        ...
        <div class="w-8/12 h-4/6 mx-auto mt-20">
            <a href="{{ route('account.create') }}" class="text-green-700 mb-5 mt-10">Crear nueva cuenta</a>
            <table class="w-full">
                ...
                <tbody>
                    @foreach ($accounts as $account)
                        <tr class="border border-gray-300">
                            <th class="text-gray-400 font-normal pt-4 pb-4">{{ $account->name}}</th>
                            <th class="text-left text-gray-400 font-normal pt-4 pb-4">{{$account->description}}</th>
                            <th class="text-green-700 font-medium pt-4 pb-4">{{$account->balance}}</th>
                            <th>
