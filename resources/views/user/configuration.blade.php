    ...
    <div class="container mx-auto px-4 py-4">
        ...
        <div class="w-8/12 h-4/6 mx-auto mt-20">
            ...
            <form action="{{ route('user.update', ['user' => $user])}}" method="POST">
                @csrf
                @method('PUT')
                <h3 class="text-gray-600 inline-block w-1/12 mt-10">nombre</h3>
                ...
                <h3 class="text-gray-600 inline-block w-1/12 mt-10">E-mail</h3>
                ...
                <button type="submit" class="px-3 py-4 text-white bg-green-500 rounded-md focus:bg-green-600 focus:outline-none hover:bg-green-600 cursor-pointer mt-10">Guardar cambios</button>
            </form>
        </div>
    </div>
